...
import 'package:invoconnection/modules/search_for_task/search_tasks_screen.dart';
...
class ConnectionAppDiscoverScreen extends StatelessWidget {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    navigateTo(context, ConnectionAppSearchUserScreen(isAdmin: false,));
                  },
            ...
            ListView.separated(
                ...
                itemBuilder: (context, index) => buildUserSearchItem(context),
                itemCount: 10),
          ],
        ),
      ),
